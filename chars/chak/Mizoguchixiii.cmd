...
[Statedef -1]
;---------------------------------------------------------------------------
; AI THOUGHT SYSTEM (Phase 3)
; var(48) fight timer, var(53) enemy state snapshot, var(54) repeat counter,
; var(55) combo momentum frames, var(56) previous life sample.
; var(51) holds the thought id and var(52) stores the display category.
;---------------------------------------------------------------------------
[State -1, Thought - Clear when human or round inactive]
type = VarSet
trigger1 = AILevel <= 0
...
[State -1, Thought - Clear category]
type = VarSet
trigger1 = AILevel <= 0
trigger2 = roundstate != 2
var(52) = 0
...
[State -1, Thought - Clear fight clock]
type = VarSet
trigger1 = AILevel <= 0
trigger2 = roundstate != 2
var(48) = 0
...
[State -1, Thought - Clear enemy snapshot]
type = VarSet
trigger1 = AILevel <= 0
trigger2 = roundstate != 2
var(53) = 0
...
[State -1, Thought - Clear repeat counter]
type = VarSet
trigger1 = AILevel <= 0
trigger2 = roundstate != 2
var(54) = 0
...
[State -1, Thought - Clear combo momentum]
type = VarSet
trigger1 = AILevel <= 0
trigger2 = roundstate != 2
var(55) = 0
...
[State -1, Thought - Clear life snapshot]
type = VarSet
trigger1 = AILevel <= 0
trigger2 = roundstate != 2
var(56) = life
...
[State -1, Thought - Clear plan lock]
type = VarSet
trigger1 = AILevel <= 0
trigger2 = roundstate != 2
var(60) = 0
...
[State -1, Thought - Clear locked plan id]
type = VarSet
trigger1 = AILevel <= 0
trigger2 = roundstate != 2
var(61) = 0
...
[State -1, Thought - Clear frustration meter]
type = VarSet
trigger1 = AILevel <= 0
trigger2 = roundstate != 2
var(62) = 0
...
[State -1, Thought - Reset ID each frame]
type = VarSet
...
[State -1, Thought - Reset category each frame]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
trigger1 = 1
...
[State -1, Thought - Clamp fight clock]
type = VarSet
trigger1 = var(48) > 9999
var(48) = 9999
ignorehitpause = 1

[State -1, Thought - Enemy state snapshot]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
trigger1 = enemynear, stateno != var(53)
var(53) = enemynear, stateno
var(54) = 0
ignorehitpause = 1

[State -1, Thought - Enemy repeat counter]
type = VarAdd
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
...
[State -1, Thought - Clamp repeat counter]
type = VarSet
trigger1 = var(54) > 720
var(54) = 720
ignorehitpause = 1

[State -1, Thought - Combo momentum up]
type = VarAdd
triggerall = AILevel > 0
triggerall = roundstate = 2
trigger1 = hitcount > 0
...
[State -1, Thought - Combo momentum cool]
type = VarAdd
triggerall = AILevel > 0
triggerall = roundstate = 2
trigger1 = hitcount = 0
...
[State -1, Thought - Clamp combo momentum]
type = VarSet
trigger1 = var(55) < 0
var(55) = 0
ignorehitpause = 1

[State -1, Thought - Cap combo momentum]
type = VarSet
trigger1 = var(55) > 180
var(55) = 180
ignorehitpause = 1

[State -1, Thought - Frustration up]
type = VarAdd
triggerall = AILevel > 0
triggerall = roundstate = 2
trigger1 = movetype = H && enemynear, movetype = A
trigger2 = movetype = H && enemynear, hitcount >= 3
trigger3 = movetype = H && enemynear, stateno = [1000,4999]
var(62) = 3
ignorehitpause = 1

[State -1, Thought - Frustration cool]
type = VarAdd
triggerall = AILevel > 0
triggerall = roundstate = 2
trigger1 = movetype != H
...
[State -1, Thought - Clamp frustration low]
type = VarSet
trigger1 = var(62) < 0
var(62) = 0
ignorehitpause = 1

[State -1, Thought - Clamp frustration high]
type = VarSet
trigger1 = var(62) > 300
var(62) = 300
ignorehitpause = 1
...
[State -1, Thought - Big Hit Reaction]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = var(51) = 0
trigger1 = var(56) > 0
trigger1 = var(56) - life >= 200
var(51) = 33
var(52) = 7
ignorehitpause = 1

[State -1, Thought - Under Fire]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
triggerall = var(51) = 0
trigger1 = movetype = H
trigger1 = enemynear, hitcount >= 3
var(51) = 34
var(52) = 2
ignorehitpause = 1

[State -1, Thought - Critical Health]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
triggerall = var(51) = 0
trigger1 = life <= ceil(lifemax * .20)
trigger1 = P2BodyDist X < 150
var(51) = 35
var(52) = 4
ignorehitpause = 1

[State -1, Thought - Wake Up Defense]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = var(51) = 0
...
[State -1, Thought - Anti-Air Ready]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
...
[State -1, Thought - Corner Pressure]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
...
trigger1 = P2BodyDist X < 140
trigger1 = (life >= enemynear, life - 80) || hitcount > 0 || enemynear, movetype = H || enemynear, ctrl = 0
var(51) = 19
var(52) = 5
ignorehitpause = 1

[State -1, Thought - Oki Setup]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
...
[State -1, Thought - Exploit Recovery]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
...
trigger1 = enemynear, movetype != A
trigger1 = power >= 1000
trigger1 = life >= enemynear, life - 50
trigger1 = BackEdgeBodyDist > 35
var(51) = 15
var(52) = 3
ignorehitpause = 1

[State -1, Thought - Close Scramble]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
...
[State -1, Thought - Keepaway]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
triggerall = var(51) = 0
trigger1 = life <= ceil(lifemax * .35) || life + 200 < enemynear, life
trigger1 = P2BodyDist X > 120
...
[State -1, Thought - Regroup]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
triggerall = var(51) = 0
trigger1 = life <= ceil(lifemax * .35)
...
[State -1, Thought - Pattern Spotted]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
...
triggerall = var(51) = 0
trigger1 = var(54) >= 120
trigger1 = life + 120 < enemynear, life
var(51) = 25
var(52) = 3
ignorehitpause = 1

[State -1, Thought - Frustrated]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
triggerall = var(51) = 0
trigger1 = var(62) >= 35
trigger2 = var(54) >= 120 && life + 150 < enemynear, life
var(51) = 26
var(52) = 7
ignorehitpause = 1

[State -1, Thought - Confidence Rising]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
triggerall = var(51) = 0
trigger1 = var(48) > 600
trigger1 = life >= enemynear, life + 250
var(51) = 27
var(52) = 7
ignorehitpause = 1

[State -1, Thought - Time Advantage]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
triggerall = var(51) = 0
trigger1 = var(48) > 1800
trigger1 = life >= enemynear, life + 60
var(51) = 28
var(52) = 6
ignorehitpause = 1

[State -1, Thought - Clock Pressure]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = NumEnemy > 0
triggerall = var(51) = 0
trigger1 = var(48) > 1800
trigger1 = life + 60 < enemynear, life
var(51) = 29
var(52) = 7
ignorehitpause = 1

[State -1, Thought - Lock plan (keepaway)]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = var(60) = 0
...
[State -1, Thought - Lock plan (corner pressure)]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = var(60) = 0
...
[State -1, Thought - Lock plan (frustrated)]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = var(60) = 0
trigger1 = var(48) >= 1800
trigger1 = var(62) >= 35 || (var(54) >= 120 && life + 150 < enemynear, life)
var(61) = 26
ignorehitpause = 1

[State -1, Thought - Lock plan fallback]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = var(60) = 0
trigger1 = var(48) >= 2000
var(61) = 21
ignorehitpause = 1

[State -1, Thought - Seal locked plan]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
trigger1 = var(60) = 0
...
[State -1, Thought - Apply locked plan]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = var(60) = 1
...
[State -1, Thought - Apply locked category]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
triggerall = var(60) = 1
triggerall = var(61) > 0
trigger1 = var(52) = 0
var(52) = cond(var(61) = 19, 5, cond(var(61) = 21, 6, cond(var(61) = 26, 7, 0)))
ignorehitpause = 1

[State -1, Thought - Default Assess]
type = VarSet
triggerall = AILevel > 0
triggerall = roundstate = 2
trigger1 = var(51) = 0
...
[State -1, Thought - Update life snapshot]
type = VarSet
